...
function overwriteTeleportTimerWhenPlayerMoves(movementTimer, standingTimer) {
    var tickRate = 500;
    ...
    while (standingTimer > 0) {
        ...
        if (startPlayerX != Player.X() || startPlayerY != Player.Y()) {
            var newTimer = movementTimer - elapsedTime;
...
function trackingRadar(userFilter) {
    if (userFilter === void 0) { userFilter = [{ name: 'Bugged', color: 0x0025, msg: '[ PK ]' }]; }
...
function transparency(allStatic) {
    if (allStatic === void 0) { allStatic = false; }
    ...
    var Common = (function () {
        ...
        Common.massMove = function (requiredCountInTarget, onlyType) {
            ...
            while (serialsToMove.length && (!requiredCountInTarget || totalInTarget !== requiredCountInTarget)) {
                var containerItemsCount = Orion.FindType('0xFFFF', '0xFFFF', 'massMoveTargetContainer').length;
        ...
        Common.hideAll = function (toggleResend) {
            if (toggleResend === void 0) { toggleResend = true; }
            var hideFn = function () {
        ...
        Common.useShrinkKad = function () {
            var kad = gameObject.potions.shrink.kad;
            Orion.UseType(kad.graphic, kad.color);
        };
        Common.transparency = function (allStatic) {
            if (allStatic === void 0) { allStatic = false; }
            var option = allStatic ? 'AllStaticTransparent' : 'UseCircleTrans';
...
(function (Scripts) {
    var Klamak = (function () {
        ...
        Klamak.klamakCooldown = function () {
            ...
            ((_b = (_a = config === null || config === void 0 ? void 0 : config.klamak) === null || _a === void 0 ? void 0 : _a.timer) === null || _b === void 0 ? void 0 : _b.displayTimer) !== false && Scripts.Klamak.displayKlamakTimer(petCoolDown);
...
(function (Scripts) {
    var MobMaster = (function () {
        ...
        MobMaster.rename = function (mob) {
            ...
            if (!canRename && Scripts.Targeting.isFriendlyTargetType(mob === null || mob === void 0 ? void 0 : mob.Graphic(), mob === null || mob === void 0 ? void 0 : mob.Color(), mobName, mobSerial)) {
        ...
        MobMaster.getStatus = function (serial, timeout) {
            ...
            if (tmp && tmp.Serial()) {
                ...
                var time = 0;
                while (time < timeout && current && (current === null || current === void 0 ? void 0 : current.Serial()) === (tmp === null || tmp === void 0 ? void 0 : tmp.Serial())) {
    ...
    var Potions = (function () {
        ...
        Potions.drinkPotion = function (potionName, switchWarModeWhenNeeded, displayTimers, displayInfo, refillEmptyLimit, displayInvisLongTimer) {
            ...
            if (m === 0) {
                ...
                displayTimers && (potionTimer === null || potionTimer === void 0 ? void 0 : potionTimer.displayTimer) !== false &&
                ...
                if (potionName === PotionsEnum.gs) {
                    ...
                    displayTimers && (gsPotionTimer === null || gsPotionTimer === void 0 ? void 0 : gsPotionTimer.displayTimer) !== false &&
                ...
                if (potionName === PotionsEnum.invis) {
                    ...
                    for (var a = 0; a < 10; a++) {
                        ...
                        if (Orion.DisplayTimerExists(id))
                            continue;
                        displayTimers && (invisPotionTimer === null || invisPotionTimer === void 0 ? void 0 : invisPotionTimer.displayTimer) !== false &&
                    ...
                    if (displayInvisLongTimer) {
                        ...
                        for (var a = 0; a < 10; a++) {
                            ...
                            if (Orion.DisplayTimerExists(id))
                                continue;
                            displayTimers && (invisLongPotionTimer === null || invisLongPotionTimer === void 0 ? void 0 : invisLongPotionTimer.displayTimer) !== false &&
...
(function (Scripts) {
    var Refill = (function () {
        ...
        Refill.regy = function (count, necroRegs) {
            if (necroRegs === void 0) { necroRegs = false; }
            ...
            var regs = necroRegs ? gameObject.necroRegy : gameObject.regy;
            for (var r in regs) {
                var reg = regs[r];
...
(function (ScrollTimerType) {
    ScrollTimerType["ivm"] = "ivm";
    ScrollTimerType["regular"] = "regular";
    ScrollTimerType["bladeSpirit"] = "bladeSpirit";
    ScrollTimerType["teleport"] = "teleport";
...
(function (Scripts) {
    var Spells = (function () {
        ...
        Spells.castScroll = function (scroll, target, backupHeadCast, existingWaitTargetHook) {
            ...
            var journal = Scripts.Utils.waitWhileSomethingInJournal(["You can't cast", 'Select Target', 'Select ghost', 'An anti-magic field disturbs', 'You lack sufficient mana']);
        ...
        Spells.getScrollTimer = function (timerType) {
            var _a;
            if (timerType === ScrollTimerType.ivm || timerType === ScrollTimerType.regular || timerType === ScrollTimerType.bladeSpirit) {
                var currentMagery = Orion.SkillValue('Magery') / 10;
                var timer = strollTimers[timerType];
                for (var magery in timer) {
                ...
                var character = Scripts.Utils.determineCharacter();
                if (!character) {
                    return 0;
                }
                var bonusItemObj = character === CharactersEnum.gangrel ?
                    gameObject.uncategorized.vampMystic :
                    character === CharactersEnum.sharpshooter ?
                        gameObject.uncategorized.teleporter :
                        undefined;
                var hasBonusItem = bonusItemObj ? !!Orion.FindType(bonusItemObj.graphic, bonusItemObj.color).length : false;
                var characterTimers = strollTimers.teleport[character];
                var standingTimer = hasBonusItem ? characterTimers.bonus.standing : characterTimers.standing;
                var movementTimer = hasBonusItem ? characterTimers.bonus.moving : characterTimers.moving;
                var timerConfig = (_a = config === null || config === void 0 ? void 0 : config.teleportTimer) === null || _a === void 0 ? void 0 : _a.timer;
                (timerConfig === null || timerConfig === void 0 ? void 0 : timerConfig.displayTimer) !== false && Orion.Exec('overwriteTeleportTimerWhenPlayerMoves', true, [movementTimer.toString(), standingTimer.toString()]);
...
(function (Scripts) {
    var Statusbar = (function () {
        ...
        Statusbar.statusAll = function (notoriery, position, id, alwaysClear, offset, shiftX, shiftY) {
            ...
            for (var i = statusAllStatusBars.length - 1; i >= 0; i--) {
                var serial = statusAllStatusBars[i];
            ...
            var notOpened = [];
            var positionId = 0;
            var unresolvedStatusBars = __spreadArrays(statusAllStatusBars);
            for (var i = 0; i < statusAllStatusBars.length; i++) {
                var _a = Scripts.Statusbar.getCoordinatesForStatusBar(position, positionId, shiftX, shiftY, offset), x = _a.x, y = _a.y;
                var nearestStatusBarDistance = 999999;
                var nearestStatusBarSerial = void 0;
                for (var j = 0; j < unresolvedStatusBars.length; j++) {
                    var serial = unresolvedStatusBars[j];
                    if (Scripts.Statusbar.exists(serial)) {
                        var position_1 = Orion.GetGumpPosition('custom', serial);
                        if (position_1) {
                            var kotvaDistance = x + y;
                            var statusbarDistance = position_1.X() + position_1.Y();
                            var distance = kotvaDistance > statusbarDistance ? kotvaDistance - statusbarDistance : statusbarDistance - kotvaDistance;
                ...
                var indexToRemove = unresolvedStatusBars.indexOf(nearestStatusBarSerial);
                indexToRemove > -1 && unresolvedStatusBars.splice(indexToRemove, 1);
                Scripts.Statusbar.moveCustomGump(nearestStatusBarSerial, x, y);
                positionId++;
            }
            var newlyOpened = [];
            for (var _b = 0, notOpened_1 = notOpened; _b < notOpened_1.length; _b++) {
                var serial = notOpened_1[_b];
                if (!Scripts.Statusbar.exists(serial) && !Orion.FindObject(serial)) {
                    continue;
                }
                var _c = Scripts.Statusbar.getCoordinatesForStatusBar(position, positionId, shiftX, shiftY, offset), x = _c.x, y = _c.y;
            ...
            var openedStatusBars = __spreadArrays(opened, newlyOpened);
            Shared.AddArray("statusAllStatusBars" + id, openedStatusBars);
            var statusBars = Shared.GetArray(GlobalEnum.customStatusBars, []);
        };
        Statusbar.moveCustomGump = function (serial, x, y) {
            var gump = Orion.CreateCustomGump(parseInt(serial, 16));
            gump.SetX(x);
            gump.SetY(y);
            gump.Update();
        };
        Statusbar.getCoordinatesForStatusBar = function (position, positionId, shiftX, shiftY, offset) {
            var _a, _b;
            var scale = ((_b = (_a = config === null || config === void 0 ? void 0 : config.statusBar) === null || _a === void 0 ? void 0 : _a.scale) !== null && _b !== void 0 ? _b : 100) / 100;
        ...
        Statusbar.hoverCheck = function () {
            while (true) {
                Orion.Wait(50);
                var statusBar_3 = Scripts.Statusbar.getHoveringStatusBar();
                if (!statusBar_3) {
                    Shared.AddVar('lastHighlightedStatusBar', undefined);
                    Orion.ClearHighlightCharacters();
                    continue;
                }
                var serial = statusBar_3.serial;
                var obj = Orion.FindObject(serial);
                if (!obj) {
                    continue;
                }
                var last = Shared.GetVar('lastHighlightedStatusBar', undefined);
                if (last !== serial) {
                    Orion.Print(serial);
                    Orion.ClearHighlightCharacters();
...
(function (Scripts) {
    var Targeting = (function () {
        ...
        Targeting.targetNext = function (reverse, timeToStorePreviousTargets, additionalFlags, notoriety, opts) {
            ...
            if (store.length &&
                ...
                while (!resolved && (nearestNewTarget === null || nearestNewTarget === void 0 ? void 0 : nearestNewTarget.length) && flags.indexOf('ignorefriendlytypes') !== -1) {
                    ...
                    var isFriendly = Scripts.Targeting.isFriendlyTargetType(t.Graphic(), t.Color(), t.Name(), t.Serial());
                    if (!isFriendly) {
                        resolved = true;
                    }
                    else {
        ...
        Targeting.isFriendlyTargetType = function (graphic, color, name, serial) {
            var _a;
...
(function (Scripts) {
    var TargetingEx = (function () {
        ...
        TargetingEx.getAliveAttackPets = function (distance) {
            if (distance === void 0) { distance = 18; }
            var arr = new Array();
            var nearPards = Orion.FindTypeEx('0x00D6', '0xFFFF', 'ground', 'live', 6);
            if (nearPards && nearPards.length) {
                for (var i = 0; i < nearPards.length; i++) {
                    var friend_2 = nearPards[i];
                    if (friend_2 && !friend_2.Dead() && friend_2.Exists() && friend_2.Distance() <= distance) {
                        arr.push(friend_2);
                    }
                }
            }
            var nearSkyhawks = Orion.FindTypeEx('0x0005', '0x0847', 'ground', 'live', 6);
            if (nearSkyhawks && nearSkyhawks.length) {
                for (var i = 0; i < nearSkyhawks.length; i++) {
                    var friend_3 = nearSkyhawks[i];
                    if (friend_3 && !friend_3.Dead() && friend_3.Exists() && friend_3.Distance() <= distance) {
                        arr.push(friend_3);
                    }
                }
            }
        ...
        TargetingEx.resolveTraget = function (targets, maxDistance) {
            ...
            for (var _i = 0, targetAliases_1 = targetAliases; _i < targetAliases_1.length; _i++) {
                ...
                if (target.alias === TargetEnum.manual) {
                    ...
                    result = TargetingEx.getTargetResultFromArray(TargetingEx.getAliveAttackPets(maxDistance), target, TargetingEx.isMobileInjured, function (a, b) { return a.Distance() - b.Distance(); });
                }
                else if (target.alias === TargetEnum.nearinjuredpetlos) {
                    result = TargetingEx.getTargetResultFromArray(TargetingEx.getAliveAttackPets(maxDistance), target, function (obj) {
                    ...
                    result = TargetingEx.getTargetResultFromArray(TargetingEx.getAliveAttackPets(maxDistance), target, TargetingEx.isMobileInjured, function (a, b) { return a.Hits() - b.Hits(); });
                }
                    ...
                    result = TargetingEx.getTargetResultFromArray(TargetingEx.getAliveAlies(maxDistance), target, TargetingEx.isMobileInjured, function (a, b) { return a.Distance() - b.Distance(); });
                }
                else if (target.alias === TargetEnum.nearinjuredalielos) {
                    result = TargetingEx.getTargetResultFromArray(TargetingEx.getAliveAlies(maxDistance), target, function (obj) {
                        return TargetingEx.isMobileInjured(obj) && obj.InLOS();
                    }, function (a, b) { return a.Distance() - b.Distance(); });
                }
                else if (target.alias === TargetEnum.mostinjuredalie) {
                    result = TargetingEx.getTargetResultFromArray(TargetingEx.getAliveAlies(maxDistance), target, TargetingEx.isMobileInjured, function (a, b) { return a.Hits() - b.Hits(); });
                }
...
(function (Scripts) {
    var TimeUtils = (function () {
        ...
        TimeUtils.parseWsTimeFromWeb = function () {
            ...
            var saveDate = Date.parse(new Date(parseInt(year, 10), parseInt(month, 10) - 1, parseInt(day, 10)));
    ...
    var Utils = (function () {
        ...
        Utils.moveItems = function (itemsSerials, targetContainerId, quantity, coordinates) {
            ...
            for (var _i = 0, itemsSerials_2 = itemsSerials; _i < itemsSerials_2.length; _i++) {
                ...
                var itemCount = itemObject.Count();
        ...
        Utils.determineCharacter = function () {
            for (var key in gameObject.books) {
                var book = gameObject.books[key];
...
(function (Scripts) {
    var Clerik = (function () {
        ...
        Clerik.useKPZ = function (cb) {
            var kpzActiveList = Orion.FindType(gameObject.medic.kpzActive.graphic, gameObject.medic.kpzActive.color, 'backpack');
            var kpzActive = kpzActiveList.length > 0 ? kpzActiveList[0] : null;
            if (kpzActive) {
        ...
        Clerik.medikHiding = function (forced) {
...
(function (Scripts) {
    ...
    var Alchemy = (function () {
        ...
        Alchemy.gmMortar = function (potionName) {
            ...
            var gmMortarObj = gameObject.uncategorized.gmMortar;
            var gmMortars = Orion.FindType(gmMortarObj.graphic, gmMortarObj.color, 'ground', '', 18);
            if (!gmMortars.length) {
                Scripts.Utils.createGameObjectSelections([{ ask: "Target gmmortar for making \"" + potionName + "\"", addObject: 'gmMortar' }]);
            }
            else {
                var gmMortar_1 = Orion.FindObject(gmMortars[0]);
...
var Scripts;
(function (Scripts) {
    var Poisoning = (function () {
        function Poisoning() {
        }
        Poisoning.getPoisonKitSerialFromBackpack = function () {
            var kit = gameObject.tools.poisonKit;
        ...
        Poisoning.getDeadlyKadSerialFromBackpack = function () {
            var kad = gameObject.potions.dp.kad;
        ...
        Poisoning.poisonGuns = function () {
            ...
            for (var _i = 0, guns_1 = guns; _i < guns_1.length; _i++) {
                var gun = guns_1[_i];
                var canMove = Scripts.Poisoning.poisonGunSerial(gun);
                canMove && Orion.MoveItem(gun, 1, 'targetPoisonedVeriteCont');
                Orion.Wait(500);
            }
        };
        Poisoning.poisonGunSerial = function (gun) {
            Scripts.Utils.worldSaveCheckWait();
            var poisonKitSerial = Scripts.Poisoning.getPoisonKitSerialFromBackpack();
            var successHlaska = 'Uspesne jsi otravil zbran';
            var failHlaska = 'Bohuzel, nepodarilo se ti otravit zbran';
            var lowHlaska = 'Nemas v kitu dostatek jedu';
            var notVeriteHlaska = 'Tohle neni ani kad, ani zbran';
            ...
            var result = Scripts.Utils.waitWhileSomethingInJournal([successHlaska, failHlaska, lowHlaska, notVeriteHlaska]);
            if (result === 0) {
                return true;
            }
            if (result === 3) {
            ...
            if (result === 2) {
                var deadlyKadSerial = Scripts.Poisoning.getDeadlyKadSerialFromBackpack();
                Orion.UseObject(poisonKitSerial);
                Orion.WaitForTarget();
        ...
        Poisoning.poisonLastAttack = function () {
        ...
        Poisoning.poisonTrain = function (serialToPoison) {
            if (!serialToPoison) {
        ...
        Poisoning.poisonTrainAuto = function () {
            var kitSerial = Scripts.Utils.findFirstType(gameObject.uncategorized.apprenticesPoisoningKit);
            if (!kitSerial) {
    ...
    Scripts.Poisoning = Poisoning;
})(Scripts || (Scripts = {}));
var RepairResultEnum;
(function (RepairResultEnum) {
    RepairResultEnum[RepairResultEnum["cant"] = 0] = "cant";
    RepairResultEnum[RepairResultEnum["progress"] = 1] = "progress";
    RepairResultEnum[RepairResultEnum["fully"] = 2] = "fully";
})(RepairResultEnum || (RepairResultEnum = {}));
var Scripts;
(function (Scripts) {
    var Repair = (function () {
        function Repair() {
        }
        Repair.toolCheck = function () {
            var sewingKit = gameObject.tools.sewingKit;
            var isSewingKit = !!Orion.FindType(sewingKit.graphic).length;
        ...
        Repair.equipDagger = function () {
            var nbDagger = gameObject.uncategorized.nbDagger;
            var dagger = gameObject.crafting.blacksmithing.ironWeapons.swordsAndBlades.dagger;
            var daggerSerial = Scripts.Utils.findFirstType(nbDagger, 1) ||
        ...
        Repair.equipHammer = function () {
            var hammer = gameObject.tools.hammer;
            var silverHammer = gameObject.tools.silverHammer;
            var hammerSerial = Scripts.Utils.findFirstType(hammer, 1) ||
        ...
        Repair.repairPlease = function () {
            ...
            var currentEquip = Scripts.Dress.getSerialsFromCurrentEquip();
            for (var _i = 0, currentEquip_1 = currentEquip; _i < currentEquip_1.length; _i++) {
                var item = currentEquip_1[_i];
                Orion.MoveItem(item, 0, char.Serial());
                Orion.Wait(500);
            }
        };
        Repair.repairTrade = function () {
            if (!Scripts.Repair.toolCheck()) {
                return;
            }
            var mobile = Orion.FindType('0xFFFF', '0xFFFF', 'ground', 'mobile|ignoreself', 3);
            for (var i = 0; i < mobile.length; i++) {
                var char = mobile[i];
                var tradeContainer = Orion.TradeContainer(char, 0);
                if (!tradeContainer) {
                    continue;
                }
        ...
        Repair.fixItemsInContainer = function (container, moveToBackpackAndReturn) {
            if (moveToBackpackAndReturn === void 0) { moveToBackpackAndReturn = false; }
            var items = Scripts.Repair.getItemsFromContainer(container);
            for (var j = 0; j < items.length; j++) {
                var itm = items[j];
                var itmObj = Orion.FindObject(itm.serial);
                var itmName = itmObj.Name();
                ...
                while (true) {
                    var repairResult = Scripts.Repair.repairItem(itm);
                    Orion.Wait(500);
                    if (repairResult === RepairResultEnum.fully) {
                        ...
                        Orion.Say(itm.name + " [nemohu opravit]");
                        break;
                    }
                }
                if (moveToBackpackAndReturn) {
        ...
        Repair.repairItem = function (item) {
            Scripts.Utils.worldSaveCheckWait();
            var naradi = gameObject.tools.repairKit;
            var patterns = [
            ...
            var patternIndex = Scripts.Utils.waitWhileSomethingInJournal(patterns);
            ...
            if ((patternIndex === 3 && !Scripts.Repair.equipDagger()) ||
        ...
        Repair.getItemsFromContainer = function (container) {
            var itemsGameObjects = Orion.FindTypeEx('0xffff', '0xffff', container);
            var items = [];
            for (var _i = 0, itemsGameObjects_1 = itemsGameObjects; _i < itemsGameObjects_1.length; _i++) {
                var item = itemsGameObjects_1[_i];
        ...
        Repair.fixLoop = function (cenaNaradi) {
            var _a;
            if (cenaNaradi === void 0) { cenaNaradi = 1000; }
            if (!Scripts.Repair.toolCheck()) {
                return;
            }
            var osloveniZakaznici = Shared.GetArray('osloveniZakaznici', []);
            var sewingKit = gameObject.tools.sewingKit;
            var gp = gameObject.uncategorized.gp;
            var brokeKitPattern = 'Naradi se pri oprave poskodilo';
            Orion.SetTimer('welcomeRepair');
            Orion.SetTimer('prupovidkaTimer', 30000);
            Scripts.Repair.randomPrupovidka();
            while (!Player.Dead()) {
                var prupovidkaTimer = Orion.Timer('prupovidkaTimer');
                ...
                for (var i = 0; i < mobile.length; i++) {
                    var char = mobile[i];
                    var charName = (_a = Orion.FindObject(char)) === null || _a === void 0 ? void 0 : _a.Name();
                    var timer = Orion.Timer('welcomeRepair');
                    ...
                    var isTradeWindowOpened = !!Orion.TradeOpponent(char);
                    var sayOnce = true;
                    var _loop_5 = function () {
                        ...
                        var isChecked = Orion.TradeCheckState(char, 0);
                        if (isChecked) {
                            var items = Scripts.Repair.getItemsFromContainer(tradeContainer);
                            var gpSerials_1 = Orion.FindType(gp.graphic, gp.color, tradeContainer);
                            if (gpSerials_1.length !== 1) {
                                gpSerials_1.length > 1 ?
                            ...
                            items = items.filter(function (itm) { return itm.serial !== gpSerials_1[0]; });
                            var zbyvaPenez = Orion.FindObject(gpSerials_1[0]).Count();
                            var konecnaCena = 0;
                            Orion.Wait(500);
                            ...
                            for (var j = 0; j < items.length; j++) {
                                var itm = items[j];
                                var itmName = Orion.FindObject(itm.serial).Name();
                                if (zbyvaPenez < cenaNaradi) {
                                    Orion.Say('Bohuzel jsi mi nedal dost penez na opravu vsech veci');
                                    for (var k = j; k < items.length; k++) {
                                        var neopravenyItem = items[k];
                                        Orion.Click(neopravenyItem.serial);
                                        Orion.Wait(responseDelay);
                                        var neopravenyItmName = Orion.FindObject(neopravenyItem.serial).Name();
                                ...
                                var charObj = Orion.FindObject(char);
                                var waitForChar = 10000;
                            ...
                            var gpObj = Orion.FindObject(gpSerials_1[0]);
                            if (gpObj) {
        ...
        Repair.welcomeTrade = function (name) {
            ...
            var emote = randEmote[Math.floor(Math.random() * randEmote.length)];
            Orion.SayEmote(emote);
        };
        Repair.randomPrupovidka = function () {
            var randPrupovidka = [
            ...
            var say = randPrupovidka[Math.floor(Math.random() * randPrupovidka.length)];
            Orion.Say(say);
        };
        return Repair;
    }());
...
(function (Scripts) {
    var Stealing = (function () {
        ...
        Stealing.getStealingTarget = function () {
            ...
            var globalStealChars = Shared.GetVar('stolenFromChars');
            if (!globalStealChars) {
        ...
        Stealing.stealing = function () {
            var stealingStartSkill = parseInt(Shared.GetVar('stealingStartSkill'));
    ...
    var Taming = (function () {
        ...
        Taming.shrinkAll = function (autotake) {
            ...
            availablePets.forEach(function (pet) {
                ...
                Orion.Wait(250);
                if (autotake) {
                    var newGroundPackSerials = Orion.FindType('0x2126|0x2127|0x211D', 'any', 'ground', 'item', 3);
...
(function (Scripts) {
    var Tracking = (function () {
        ...
        Tracking.radar = function (userFilter) {
            if (userFilter === void 0) { userFilter = []; }
            var noSigns = 'You see no signs';
            Orion.ClearJournal(noSigns);
            Scripts.Tracking.tracking('Anything that moves');
            Orion.Wait(responseDelay);
            var timeout = 1000;
            var trackMenu = undefined;
            ...
            var _loop_6 = function (i) {
                var name_3 = trackMenu.ItemName(i);
                var graphic = trackMenu.ItemGraphic(i);
                var find = trackList.filter(function (item) { return item.name === name_3; })[0];
                if (!find) {
                    trackList.push({ name: name_3, count: 1, graphic: graphic });
                }
                else {
                    find.count++;
                }
            };
            for (var i = 0; i < trackMenu.ItemsCount(); i++) {
                _loop_6(i);
            }
            trackMenu.Close();
            Scripts.Utils.log(" -- TRACKING LIST -- [" + Player.X() + ", " + Player.Y() + "]");
            var specialFilter = __spreadArrays([
            ...
            var _loop_7 = function (item) {
                var special = specialFilter.filter(function (i) { return i.name.toUpperCase() === item.name.toUpperCase(); })[0];
                var isHuman = item.graphic == '0x2106' || item.graphic == '0x2107';
                if (special) {
...
(function (TargetEnum) {
    ...
    TargetEnum["nearinjuredpet"] = "nearinjuredpet";
    TargetEnum["nearinjuredalielos"] = "nearinjuredalielos";
    TargetEnum["nearinjuredpetlos"] = "nearinjuredpetlos";
    TargetEnum["mostinjuredalie"] = "mostinjuredalie";
    TargetEnum["mostinjuredpet"] = "mostinjuredpet";
    TargetEnum["mostinjuredalielos"] = "mostinjuredalielos";
    TargetEnum["mostinjuredpetlos"] = "mostinjuredpetlos";
...
var CharactersEnum;
(function (CharactersEnum) {
    CharactersEnum["necromancer"] = "necromancer";
    CharactersEnum["mage"] = "mage";
    CharactersEnum["gangrel"] = "gangrel";
    CharactersEnum["craftsman"] = "craftsman";
    CharactersEnum["medic"] = "medic";
    CharactersEnum["sharpshooter"] = "sharpshooter";
    CharactersEnum["paladin"] = "paladin";
    CharactersEnum["warrior"] = "warrior";
    CharactersEnum["brujah"] = "brujah";
    CharactersEnum["druid"] = "druid";
    CharactersEnum["cleric"] = "cleric";
    CharactersEnum["shaman"] = "shaman";
})(CharactersEnum || (CharactersEnum = {}));
