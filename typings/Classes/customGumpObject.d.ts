declare interface CustomGumpObject {
    ...
    AddButton(
        ...
        y: number,
        graphic: string,
        graphicSelected: string,
        graphicPressed: string,
        color: string,
        action?: number,
        toPage?: number,
    ): void;
    ...
    AddComboBox(
        ...
        y: number,
        graphic: string,
        compositeBackground: number,
        openGraphic: string,
        width: number,
        textOffsetY: number,
        showItemsCount?: number,
        centerMaximized?: number,
    );
    ...
    AddSpoiler(
        ...
        graphicSelected: string | number,
        graphicPressed: string | number,
        openedGraphic: string,
        openedGraphicSelected: string,
        openedGraphicPressed: string,
        color?: string,
    );
    ...
    SetSpoilerText(
        text?: string,
        color?: string | number,
        colorSelected?: string | number,
        colorOpened?: string | number,
        font?: number,
    );
